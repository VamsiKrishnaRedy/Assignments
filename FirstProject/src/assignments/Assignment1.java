...
public class Assignment1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Scanner s3=new Scanner(System.in);
		 * System.out.println("Enter the name to fetch the detais;"); String
		 * a1=s3.next(); String QUERY = "select * from details " +
		 * "where Name='"+a1+"' ";
		 * 
		 * 
		 ...
		 * stmt.executeQuery(QUERY); ) { while(rs.next()){ //Display values
